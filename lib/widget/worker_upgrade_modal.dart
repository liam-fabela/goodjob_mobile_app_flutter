...
class WorkerUpgradeModal extends StatefulWidget {
   final Function onSelectImage;
  WorkerUpgradeModal(this.onSelectImage);
  @override
  _WorkerUpgradeModalState createState() => _WorkerUpgradeModalState();
}

class _WorkerUpgradeModalState extends State<WorkerUpgradeModal> {
