...
class WorkerChangeModal extends StatefulWidget {
  final Function onSelectImage;
  WorkerChangeModal(this.onSelectImage);
  @override
  _WorkerChangeModalState createState() => _WorkerChangeModalState();
}

class _WorkerChangeModalState extends State<WorkerChangeModal> {
