...
class Worker5SignUp extends StatefulWidget {

 static const routeName = '/worker5-signup';

  @override
  _Worker5SignUpState createState() => _Worker5SignUpState();
}

class _Worker5SignUpState extends State<Worker5SignUp> {
 File _pickedImage1;
 File _pickedImage2;
 String file1;
 String file2;
        ...
        children: <Widget>[
          ...
          Stack(
            children: <Widget>[
              ...
              SizedBox(height: 20),
              ImageInput2(_selectImage1, _selectImage2),
                      ],
                      ),
              ),
               GestureDetector(
